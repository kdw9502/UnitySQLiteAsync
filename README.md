...
[Download package](https://github.com/kdw9502/UnitySQLiteAsync/releases/download/1.1.0/UnitySQLiteAsync.unitypackage) and import to your Unity project. You don't need to import test scripts in UnitySQLiteAsync package.
